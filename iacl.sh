...
useradd sebastiao -m -s /bin/bash -p $(openssl -crypt Senha123) -G GRP_VEN
useradd robeto -m -s /bin/bash -p $(openssl -crypt Senha123) -G GRP_VEN
...
echo "Especificando permissoes de diretorios aos usuários..."
